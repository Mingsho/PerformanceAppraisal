...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <EditItemTemplate>
            ...
            <div class="form-group">
                <asp:Label ID="lbl2HouseUnitNo" runat="server"
                    Text="House/Unit No:" AssociatedControlID="txtHouseUnitNo">
                </asp:Label>
                <asp:TextBox ID="txtHouseUnitNo" runat="server"
                    Text='<%# Bind("HouseUnitNo") %>'></asp:TextBox>
            </div>

            <div class="form-group">
                <asp:Label ID="lbl2Streetname" runat="server"
                    Text="Streetname" AssociatedControlID="txtStreetname">
                </asp:Label>
